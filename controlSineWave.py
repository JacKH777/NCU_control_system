...
# fileDir_up = os.path.join('./exp/','2024_10_20_1144', '1', 'up_model.npy')
# fileDir_down = os.path.join('./exp/','2024_10_20_1144', '1', 'down_model.npy')
...
# # FNN 初始化
# up = ANFIS()
# # fileDir_up = os.path.join('./exp/','2024_10_20_1332', '1', 'up_model.npy')
