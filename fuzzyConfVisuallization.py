...
# sin_wave[0:250] = 30
# sin_wave[250*2:250*4] = 30
# sin_wave[250*5:250*6] = 30
# sin_wave[250*7:250*9] = 30
...
# d_voltage = np.diff(voltage,  append=voltage[-1])*25
...
plt.subplot(6, 1, 6) # (行数, 列数, 子图编号)
plt.plot(time, angle, label='Angle')
plt.plot(time, target_period_1, color=(0, 0, 0, 0.5), linestyle='--', label='Desire Angle')
plt.xlabel('Time (Sec)')
plt.ylabel('Angle (Deg)')
plt.legend()
plt.grid(True)
