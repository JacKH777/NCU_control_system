...
from fuzzy_neural_principle import fuzzy_system
...
class DataReceiveThreads(Ui_MainWindow):
    ...
    def data_recv(self, queue_comport, queue_voltage, queue_gui_message,queue_receive_deg, queue_desire_deg, queue_control_value):
        ...
        while True:
            ...
            new_gauss_center,new_gauss_width = a.output_gauss_learning(error,0.01,output_m)
            a.new_output_gauss(self,new_gauss_center,new_gauss_width)
            new_u = new_u * 0.01
