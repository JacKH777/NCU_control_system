...
from kerasFuzzy import Torque_ANFIS_multi_pos, go_to_desire_angle,Torque_ANFIS_2kg_multi
...
# 主程序函数：用于数据采集与计算控制
def control_loop():
    global h_train,train_torque,train_desire_torque, voltage_his, angle_his, up_model_his,delta_error_his
    ...
    while cycle < total_cycle:
        ...
        # 判断是否触发训练
        if cycle > 1 and not train_event_up.is_set() and idx % 2 == 1:
            # print("ok_up")
            up.update_parameter()
