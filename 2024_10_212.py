...
# data_date = '2024_10_21_2115' #1kg 10*40 2FNN
# data_date = '2024_10_21_2158' #2kg 10*40 1FNN
# data_date = '2024_10_21_2143' #2kg 10*40 2FNN
data_date = '2024_11_04_0853' #0kg 10*40 2FNN 0.01learning Rate
data_date = '2024_11_04_0932' #0kg 10*40 2FNN 0.0001learning Rate
...
# angle_10_1 = split_data(angle_1, 30)
...
plt.figure(figsize=(10, 8))
plt.plot(range(1,len(rmses)+1),rmses,label = '1-FNN') 
# plt.plot(range(1,len(rmses)+1),rmses_1,label = '2-FNN') 
plt.grid(True)
